...
// 监听图表模式和类型变化，渲染图表
watch([dataViewMode, chartType, () => props.queryData], async ([mode]) => {
  if (mode === 'chart') {
    await nextTick()
    renderChart()
  }
